...
public class UserBaseImpl implements UserBaseService {
            ...
            result -> {
              ...
              if (userBaseDO == null) {
                ...
                couponDO.setUcCouponValidity(
                    DateUtils.convertToString(LocalDateTime.now().plus(30L, ChronoUnit.DAYS)));
   ...
   */
  @Override
  public Mono<ResultInfo<List<UserBaseDTO>>> queryUserList(
      ServerWebExchange serverWebExchange, Integer ubdAdmin) {
